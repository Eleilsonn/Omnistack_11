...
export default function Detail() {
    ...
    const message = `Olá, ajudarei neste caso: ${incident.title} com o valor de: ${Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL' }).format(incident.value)}`;
        ...
        <View style={style.container}>
            ...
            <View style={style.contactBox}>
                ...
                <View style={style.actions}>
                    ...
                    <TouchableOpacity onPress={sendEmail} style={style.action}>
